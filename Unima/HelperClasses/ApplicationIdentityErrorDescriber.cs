...
public class ApplicationIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string? userName) => new IdentityError { Code = nameof(InvalidUserName), Description = "شماره دانشجویی باید شامل اعداد (0-9) باشد." };
